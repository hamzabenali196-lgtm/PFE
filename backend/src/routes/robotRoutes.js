...
robotRoutes.get('/state', (req, res) => {
  res.json(robotState);
});

robotRoutes.get('/history', (req, res) => {
  res.json(getHistoryItems());
});

robotRoutes.delete('/history/:id', async (req, res) => {
...
robotRoutes.get('/mic', (req, res) => {
  res.json(getMicState());
});

robotRoutes.post('/mic', async (req, res) => {
  try {
...
robotRoutes.get('/recordings', (req, res) => {
  res.json(getRecordings());
});

robotRoutes.post('/recordings/start', async (req, res) => {
  try {
...
robotRoutes.post('/recordings/stop', async (req, res) => {
  try {
...
robotRoutes.delete('/recordings/:id', async (req, res) => {
...
robotRoutes.get('/videos', (req, res) => {
  res.json(getVideoRecordings());
});

robotRoutes.post('/videos/start', async (req, res) => {
  try {
...
robotRoutes.post('/videos/stop', async (req, res) => {
  try {
...
robotRoutes.delete('/videos/:id', async (req, res) => {
...
robotRoutes.post('/servo', (req, res) => {
  try {
